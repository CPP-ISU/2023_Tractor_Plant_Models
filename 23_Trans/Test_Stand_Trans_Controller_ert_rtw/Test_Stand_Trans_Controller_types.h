 ...
 *
 * File: Test_Stand_Trans_Controller_types.h
 *
...
#ifndef RTW_HEADER_Test_Stand_Trans_Controller_types_h_
#define RTW_HEADER_Test_Stand_Trans_Controller_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_emxArray_char_T_Test_Stand_Tr_T
#define typedef_emxArray_char_T_Test_Stand_Tr_T

typedef struct emxArray_char_T emxArray_char_T_Test_Stand_Tr_T;

#endif                             /* typedef_emxArray_char_T_Test_Stand_Tr_T */

/* Parameters (default storage) */
typedef struct P_Test_Stand_Trans_Controller_T_ P_Test_Stand_Trans_Controller_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Test_Stand_Trans_Cont_T RT_MODEL_Test_Stand_Trans_Con_T;

#endif                     /* RTW_HEADER_Test_Stand_Trans_Controller_types_h_ */
