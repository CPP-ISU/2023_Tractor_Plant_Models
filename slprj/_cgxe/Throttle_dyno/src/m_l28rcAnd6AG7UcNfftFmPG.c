...
static void cgxe_mdl_start(InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_CANTransmit *obj);
static void mw__internal__call__reset(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance, const emlrtStack *sp);
static uint8_T mw__internal__call__step(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_l28rcAnd6AG7UcNfftFmPG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_l28rcAnd6AG7UcNfftFmPG(SimStruct *S, int_T tid)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_l28rcAnd6AG7UcNfftFmPG(SimStruct *S, int_T tid)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_l28rcAnd6AG7UcNfftFmPG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
  InstanceStruct_l28rcAnd6AG7UcNfftFmPG *moduleInstance =
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG *)calloc(1, sizeof
    (InstanceStruct_l28rcAnd6AG7UcNfftFmPG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_l28rcAnd6AG7UcNfftFmPG);
  ssSetmdlInitializeConditions(S, mdlInitialize_l28rcAnd6AG7UcNfftFmPG);
  ssSetmdlUpdate(S, mdlUpdate_l28rcAnd6AG7UcNfftFmPG);
  ssSetmdlTerminate(S, mdlTerminate_l28rcAnd6AG7UcNfftFmPG);
  ssSetmdlEnable(S, mdlEnable_l28rcAnd6AG7UcNfftFmPG);
  ssSetmdlDisable(S, mdlDisable_l28rcAnd6AG7UcNfftFmPG);
...
static void mdlProcessParameters_l28rcAnd6AG7UcNfftFmPG(SimStruct *S)
{
}

void method_dispatcher_l28rcAnd6AG7UcNfftFmPG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_l28rcAnd6AG7UcNfftFmPG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_l28rcAnd6AG7UcNfftFmPG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_l28rcAnd6AG7UcNfftFmPG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_l28rcAnd6AG7UcNfftFmPG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: l28rcAnd6AG7UcNfftFmPG.\n"
...
mxArray *cgxe_l28rcAnd6AG7UcNfftFmPG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_l28rcAnd6AG7UcNfftFmPG_fallback_info(void)
{
