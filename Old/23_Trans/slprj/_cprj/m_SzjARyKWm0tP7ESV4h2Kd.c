...
#include "m_SzjARyKWm0tP7ESV4h2Kd.h"
...
static void cgxe_mdl_start(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static void mw__internal__system__init__fcn(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_CANReceive *obj);
static void mw__internal__call__reset(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance, const emlrtStack *sp, real_T SampleTime);
static void mw__internal__call__step(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
...
static const mxArray *emlrt_marshallOut(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
...
static void cgxe_mdl_set_sim_state(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
...
static void init_simulink_io_address(InstanceStruct_SzjARyKWm0tP7ESV4h2Kd
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S, int_T tid)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S, int_T tid)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void setSimState_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
  InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *moduleInstance =
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd *)calloc(1, sizeof
    (InstanceStruct_SzjARyKWm0tP7ESV4h2Kd));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_SzjARyKWm0tP7ESV4h2Kd);
  ssSetmdlInitializeConditions(S, mdlInitialize_SzjARyKWm0tP7ESV4h2Kd);
  ssSetmdlUpdate(S, mdlUpdate_SzjARyKWm0tP7ESV4h2Kd);
  ssSetmdlTerminate(S, mdlTerminate_SzjARyKWm0tP7ESV4h2Kd);
  ssSetmdlEnable(S, mdlEnable_SzjARyKWm0tP7ESV4h2Kd);
  ssSetmdlDisable(S, mdlDisable_SzjARyKWm0tP7ESV4h2Kd);
...
static void mdlProcessParameters_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S)
{
}

void method_dispatcher_SzjARyKWm0tP7ESV4h2Kd(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_SzjARyKWm0tP7ESV4h2Kd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_SzjARyKWm0tP7ESV4h2Kd(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_SzjARyKWm0tP7ESV4h2Kd(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_SzjARyKWm0tP7ESV4h2Kd(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: SzjARyKWm0tP7ESV4h2Kd.\n"
...
mxArray *cgxe_SzjARyKWm0tP7ESV4h2Kd_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_SzjARyKWm0tP7ESV4h2Kd_fallback_info(void)
{
