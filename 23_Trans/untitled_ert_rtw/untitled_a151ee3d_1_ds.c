 ...
 */
/* untitled_a151ee3d_1_ds.c - body for module untitled_a151ee3d_1_ds */

#include "ne_ds.h"
#include "untitled_a151ee3d_1_ds_zc.h"
#include "untitled_a151ee3d_1_ds_obs_il.h"
#include "untitled_a151ee3d_1_ds_obs_all.h"
#include "untitled_a151ee3d_1_ds_obs_act.h"
#include "untitled_a151ee3d_1_ds_obs_exp.h"
#include "untitled_a151ee3d_1_ds_log.h"
#include "untitled_a151ee3d_1_ds_dxf.h"
#include "untitled_a151ee3d_1_ds_mode.h"
#include "untitled_a151ee3d_1_ds_f.h"
...
static NeEquationData s_equation_data[8] = { { "", 0U, 8,
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 2U, 0U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "untitled/Ideal Translational Motion Sensor", 1U, 2U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1U, 3U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "untitled/Translational Friction", 1U, 4U, FALSE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "untitled/4-Way Directional Valve", 1U, 5U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "untitled/4-Way Directional Valve", 1U, 6U, FALSE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "untitled/4-Way Directional Valve", 1U, 7U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "untitled/4-Way Directional Valve", 1U, 8U, FALSE, 1.0, "1", } };
...
static NeVariableData s_variable_data[8] = { {
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1.0, "1", 0.0, TRUE,
    FALSE, { { 1, 1 } }, NE_INIT_MODE_MANDATORY, "Piston position", }, {
    "Ideal_Translational_Motion_Sensor.x", 0U, 0,
    "untitled/Ideal Translational Motion Sensor", 1.0, "1", 0.0, TRUE, FALSE, {
        { 1, 1 } }, NE_INIT_MODE_MANDATORY, "Position", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.A.p", 0U, 1,
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1.0, "1", 0.0, FALSE,
    FALSE, { { 1, 1 } }, NE_INIT_MODE_NONE, "Pressure", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.B.p", 0U, 1,
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1.0, "1", 0.0, FALSE,
    FALSE, { { 1, 1 } }, NE_INIT_MODE_NONE, "Pressure", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.flow_rate_A", 0U, 0,
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1.0, "1", 0.0, FALSE,
    FALSE, { { 1, 1 } }, NE_INIT_MODE_NONE, "Flow rate into port A", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.force", 0U, 0,
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1.0, "1", 0.0, FALSE,
    FALSE, { { 1, 1 } }, NE_INIT_MODE_NONE, "Actuator force from C to R", }, {
    "x4_Way_Directional_Valve.orifice_P_A.flow_rate", 0U, 0,
    "untitled/4-Way Directional Valve", 1.0, "1", 0.0, FALSE, FALSE, { { 1, 1 }
    }, NE_INIT_MODE_NONE, "Volumetric flow rate", }, {
...
static NeObservableData s_observable_data[56] = { {
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "Pa",
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "m/s",
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "m^3/s",
    1.0, "cm^3/s", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate into port A", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.flow_rate_B",
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "m^3/s",
    1.0, "cm^3/s", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Flow rate out of port B", }, {
    "Double_Acting_Hydraulic_Cylinder_Simple.force",
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "N", 1.0,
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "m", 1.0,
    ...
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", { { 1, 1 } }, "m/s",
    1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Actuator velocity", }, {
    "Hydraulic_Constant_Pressure_Source.P.p",
    "untitled/Hydraulic Constant Pressure Source", { { 1, 1 } }, "Pa", 1.0,
    ...
    "untitled/Hydraulic Constant Pressure Source", { { 1, 1 } }, "m^3/s", 1.0,
    ...
    "untitled/Hydraulic Constant Pressure Source", { { 1, 1 } }, "W", 1.0, "kW",
    ...
    "Hydraulic_Reference.P.p", "untitled/Hydraulic Reference", { { 1, 1 } },
    "Pa", 1.0, "bar", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "Ideal_Translational_Motion_Sensor.A",
    "untitled/Ideal Translational Motion Sensor", { { 1, 1 } }, "m/s^2", 1.0,
    ...
    "untitled/Ideal Translational Motion Sensor", { { 1, 1 } }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Ideal_Translational_Motion_Sensor.P",
    "untitled/Ideal Translational Motion Sensor", { { 1, 1 } }, "m", 1.0, "m",
    ...
    "Ideal_Translational_Motion_Sensor_P", "untitled/PS-Simulink\nConverter", {
        { 1, 1 } }, "in", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Translational_Motion_Sensor_P", }, {
    "Mechanical_Translational_Reference.V.v",
    "untitled/Mechanical Translational Reference", { { 1, 1 } }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Simulink_PS_Converter1_output", "untitled/Simulink-PS\nConverter1", { { 1,
        1 } }, "mm", 1.0, "mm", NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Simulink_PS_Converter1_output", }, { "Translational_Friction.C.v",
    "untitled/Translational Friction", { { 1, 1 } }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Friction.R.v", "untitled/Translational Friction", { { 1, 1 }
    }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Friction.f", "untitled/Translational Friction", { { 1, 1 } },
    "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Translational_Friction.v",
    "untitled/Translational Friction", { { 1, 1 } }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Friction.power_dissipated", "untitled/Translational Friction",
    { { 1, 1 } }, "N*m/s", 1.0, "N*m/s", NE_NOMINAL_SOURCE_NONE,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE,
    "power_dissipated", }, { "x4_Way_Directional_Valve.A.p",
    "untitled/4-Way Directional Valve", { { 1, 1 } }, "Pa", 1.0, "bar",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.B.p", "untitled/4-Way Directional Valve", { { 1, 1
      } }, "Pa", 1.0, "bar", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.P.p", "untitled/4-Way Directional Valve", { { 1, 1
      } }, "Pa", 1.0, "bar", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.S", "untitled/4-Way Directional Valve", { { 1, 1 }
    }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, { "x4_Way_Directional_Valve.T.p",
    "untitled/4-Way Directional Valve", { { 1, 1 } }, "Pa", 1.0, "bar",
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.orifice_A_T.S", "untitled/4-Way Directional Valve",
    ...
    "untitled/4-Way Directional Valve", { { 1, 1 } }, "m^3/s", 1.0, "cm^3/s",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.orifice_B_T.S", "untitled/4-Way Directional Valve",
    { { 1, 1 } }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.orifice_P_A.S", "untitled/4-Way Directional Valve",
    { { 1, 1 } }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Pressure", }, {
    "x4_Way_Directional_Valve.orifice_P_B.S", "untitled/4-Way Directional Valve",
    { { 1, 1 } }, "m", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
...
static NeZCData s_zc_data[14] = { {
    "untitled/Double-Acting Hydraulic Cylinder (Simple)", 1U, 0U,
    ...
    NE_ZC_TYPE_FALSE, }, { "untitled/Double-Acting Hydraulic Cylinder (Simple)",
    1U, 1U, "Double_Acting_Hydraulic_Cylinder_Simple",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+cylinders/cylinder_da_simple.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 2U,
    ...
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 3U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 4U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 5U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 6U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 7U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 8U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 9U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 10U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 11U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 12U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, }, { "untitled/4-Way Directional Valve", 1U, 13U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    NE_ZC_TYPE_FALSE, } };
...
static NeAssertData s_assert_data[39] = { { "untitled/4-Way Directional Valve",
    1U, 0U, "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 1U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 2U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 3U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 4U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 5U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 6U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 7U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/Translational Friction", 1U, 8U, "Translational_Friction",
    ...
    "untitled/Translational Friction", 1U, 9U, "Translational_Friction",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/friction.ssc",
    FALSE,
    ...
    "untitled/Translational Friction", 1U, 10U, "Translational_Friction",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+translational/friction.ssc",
    TRUE,
    ...
    "untitled/4-Way Directional Valve", 1U, 11U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 12U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 13U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 14U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 15U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 16U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 17U,
    "x4_Way_Directional_Valve.orifice_A_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 18U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 19U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 20U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 21U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 22U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 23U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 24U,
    "x4_Way_Directional_Valve.orifice_B_T",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 25U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 26U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 27U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 28U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 29U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 30U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 31U,
    "x4_Way_Directional_Valve.orifice_P_A",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "untitled/4-Way Directional Valve", 1U, 32U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 33U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 34U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 35U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 36U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "untitled/4-Way Directional Valve", 1U, 37U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "untitled/4-Way Directional Valve", 1U, 38U,
    "x4_Way_Directional_Valve.orifice_P_B",
    "C:/Program Files/MATLAB/R2022b/toolbox/physmod/sh/sh/+sh/+orifices/orifice_variable.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", } };
...
NeDynamicSystem *untitled_a151ee3d_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mMethods[NE_DS_METHOD_F] = untitled_a151ee3d_1_ds_f;
  ...
  ds->mMethods[NE_DS_METHOD_DXF] = untitled_a151ee3d_1_ds_dxf;
  ...
  ds->mMethods[NE_DS_METHOD_DUF] = untitled_a151ee3d_1_ds_duf;
  ...
  ds->mMethods[NE_DS_METHOD_MODE] = untitled_a151ee3d_1_ds_mode;
  ds->mMakeOutput[NE_DS_METHOD_MODE] = ds_output_mode;
  ds->mMethods[NE_DS_METHOD_ZC] = untitled_a151ee3d_1_ds_zc;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = untitled_a151ee3d_1_ds_log;
  ds->mMakeOutput[NE_DS_METHOD_LOG] = ds_output_log;
  ds->mMethods[NE_DS_METHOD_ASSERT] = untitled_a151ee3d_1_ds_assert;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = untitled_a151ee3d_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = untitled_a151ee3d_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = untitled_a151ee3d_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = untitled_a151ee3d_1_ds_obs_il;
