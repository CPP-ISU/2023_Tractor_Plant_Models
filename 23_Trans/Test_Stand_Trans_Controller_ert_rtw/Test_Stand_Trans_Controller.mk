###########################################################################
## Makefile generated for component 'Test_Stand_Trans_Controller'. 
## 
## Makefile     : Test_Stand_Trans_Controller.mk
## Generated on : Fri Jan 27 15:44:59 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Test_Stand_Trans_Controller.elf
...
PRODUCT_NAME              = Test_Stand_Trans_Controller
MAKEFILE                  = Test_Stand_Trans_Controller.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Test_Stand_Trans_Controller.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/src -I$(START_DIR)/Test_Stand_Trans_Controller_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_CAN_BITRATE=250000 -DMW_CAN_ALLOWALLMSGS=1 -DMW_NUM_CAN_TRANSMIT=2 -DMW_NUM_CAN_RECEIVE=1
...
DEFINES_STANDARD = -DMODEL=Test_Stand_Trans_Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/src/MW_SocketCAN.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/raspberrypi/src/MW_SocketCAN_raspi.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/Test_Stand_Trans_Controller.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/Test_Stand_Trans_Controller_data.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/can_datatype_ground.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rtGetInf.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rtGetNaN.c $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rt_nonfinite.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/src/MW_raspi_init.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/ert_main.c
...
OBJS = MW_SocketCAN.c.o MW_SocketCAN_raspi.c.o Test_Stand_Trans_Controller.c.o Test_Stand_Trans_Controller_data.c.o can_datatype_ground.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Test_Stand_Trans_Controller.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/Test_Stand_Trans_Controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Test_Stand_Trans_Controller_data.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/Test_Stand_Trans_Controller_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


can_datatype_ground.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/can_datatype_ground.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Test_Stand_Trans_Controller_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
