###########################################################################
## Makefile generated for component 'Steering_Plant_Model_Pi'. 
## 
## Makefile     : Steering_Plant_Model_Pi.mk
## Generated on : Wed Feb 08 16:21:25 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Steering_Plant_Model_Pi.elf
...
PRODUCT_NAME              = Steering_Plant_Model_Pi
MAKEFILE                  = Steering_Plant_Model_Pi.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Steering_Plant_Model_Pi.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/linux/src -I$(START_DIR)/Steering_Plant_Model_Pi_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=Steering_Plant_Model_Pi -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SocketCAN.c.o MW_SocketCAN_raspi.c.o Steering_Plant_Model_Pi.c.o Steering_Plant_Model_Pi_data.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Steering_Plant_Model_Pi.c.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/Steering_Plant_Model_Pi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Steering_Plant_Model_Pi_data.c.o : $(START_DIR)/Steering_Plant_Model_Pi_ert_rtw/Steering_Plant_Model_Pi_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
