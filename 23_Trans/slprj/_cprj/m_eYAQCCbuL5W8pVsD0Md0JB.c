...
static void cgxe_mdl_start(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_CANReceive *obj);
static void mw__internal__call__reset(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance, const emlrtStack *sp, real_T SampleTime);
static void mw__internal__call__step(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
...
static const mxArray *emlrt_marshallOut(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
...
static void init_simulink_io_address(InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S, int_T tid)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S, int_T tid)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
  InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *moduleInstance =
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB *)calloc(1, sizeof
    (InstanceStruct_eYAQCCbuL5W8pVsD0Md0JB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_eYAQCCbuL5W8pVsD0Md0JB);
  ssSetmdlInitializeConditions(S, mdlInitialize_eYAQCCbuL5W8pVsD0Md0JB);
  ssSetmdlUpdate(S, mdlUpdate_eYAQCCbuL5W8pVsD0Md0JB);
  ssSetmdlTerminate(S, mdlTerminate_eYAQCCbuL5W8pVsD0Md0JB);
  ssSetmdlEnable(S, mdlEnable_eYAQCCbuL5W8pVsD0Md0JB);
  ssSetmdlDisable(S, mdlDisable_eYAQCCbuL5W8pVsD0Md0JB);
...
static void mdlProcessParameters_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S)
{
}

void method_dispatcher_eYAQCCbuL5W8pVsD0Md0JB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_eYAQCCbuL5W8pVsD0Md0JB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_eYAQCCbuL5W8pVsD0Md0JB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_eYAQCCbuL5W8pVsD0Md0JB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_eYAQCCbuL5W8pVsD0Md0JB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: eYAQCCbuL5W8pVsD0Md0JB.\n"
...
mxArray *cgxe_eYAQCCbuL5W8pVsD0Md0JB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_eYAQCCbuL5W8pVsD0Md0JB_fallback_info(void)
{
