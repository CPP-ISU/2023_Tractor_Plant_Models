...
static void cgxe_mdl_start(InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_CANReceive *obj);
static void mw__internal__call__reset(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance, const emlrtStack *sp, real_T SampleTime);
static void mw__internal__call__step(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
...
static const mxArray *emlrt_marshallOut(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
...
static void init_simulink_io_address(InstanceStruct_GacRQAA80wK47Fj0f9XGeC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_GacRQAA80wK47Fj0f9XGeC(SimStruct *S, int_T tid)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_GacRQAA80wK47Fj0f9XGeC(SimStruct *S, int_T tid)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_GacRQAA80wK47Fj0f9XGeC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
  InstanceStruct_GacRQAA80wK47Fj0f9XGeC *moduleInstance =
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC *)calloc(1, sizeof
    (InstanceStruct_GacRQAA80wK47Fj0f9XGeC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_GacRQAA80wK47Fj0f9XGeC);
  ssSetmdlInitializeConditions(S, mdlInitialize_GacRQAA80wK47Fj0f9XGeC);
  ssSetmdlUpdate(S, mdlUpdate_GacRQAA80wK47Fj0f9XGeC);
  ssSetmdlTerminate(S, mdlTerminate_GacRQAA80wK47Fj0f9XGeC);
  ssSetmdlEnable(S, mdlEnable_GacRQAA80wK47Fj0f9XGeC);
  ssSetmdlDisable(S, mdlDisable_GacRQAA80wK47Fj0f9XGeC);
...
static void mdlProcessParameters_GacRQAA80wK47Fj0f9XGeC(SimStruct *S)
{
}

void method_dispatcher_GacRQAA80wK47Fj0f9XGeC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_GacRQAA80wK47Fj0f9XGeC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_GacRQAA80wK47Fj0f9XGeC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_GacRQAA80wK47Fj0f9XGeC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_GacRQAA80wK47Fj0f9XGeC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: GacRQAA80wK47Fj0f9XGeC.\n"
...
mxArray *cgxe_GacRQAA80wK47Fj0f9XGeC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_GacRQAA80wK47Fj0f9XGeC_fallback_info(void)
{
