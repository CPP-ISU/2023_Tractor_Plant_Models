...
#include "untitled_a151ee3d_1_gateway.h"

void untitled_a151ee3d_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.001, 0, 0, 0, 0, (SscLoggingSetting) 0, 597793876, 1,
  };
  ...
  untitled_a151ee3d_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("untitled/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
