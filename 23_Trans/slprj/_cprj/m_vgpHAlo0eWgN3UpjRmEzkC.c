...
static void cgxe_mdl_start(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_CANTransmit *obj);
static void mw__internal__call__reset(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S, int_T tid)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S, int_T tid)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
  InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *moduleInstance =
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC *)calloc(1, sizeof
    (InstanceStruct_vgpHAlo0eWgN3UpjRmEzkC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_vgpHAlo0eWgN3UpjRmEzkC);
  ssSetmdlInitializeConditions(S, mdlInitialize_vgpHAlo0eWgN3UpjRmEzkC);
  ssSetmdlUpdate(S, mdlUpdate_vgpHAlo0eWgN3UpjRmEzkC);
  ssSetmdlTerminate(S, mdlTerminate_vgpHAlo0eWgN3UpjRmEzkC);
  ssSetmdlEnable(S, mdlEnable_vgpHAlo0eWgN3UpjRmEzkC);
  ssSetmdlDisable(S, mdlDisable_vgpHAlo0eWgN3UpjRmEzkC);
...
static void mdlProcessParameters_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S)
{
}

void method_dispatcher_vgpHAlo0eWgN3UpjRmEzkC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_vgpHAlo0eWgN3UpjRmEzkC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_vgpHAlo0eWgN3UpjRmEzkC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_vgpHAlo0eWgN3UpjRmEzkC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_vgpHAlo0eWgN3UpjRmEzkC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: vgpHAlo0eWgN3UpjRmEzkC.\n"
...
mxArray *cgxe_vgpHAlo0eWgN3UpjRmEzkC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_vgpHAlo0eWgN3UpjRmEzkC_fallback_info(void)
{
